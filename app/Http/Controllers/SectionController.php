...
class SectionController extends Controller {
	...
	private function natSort($obj) {
		return $obj->orderBy(DB::raw('LENGTH(x.name)'))->orderBy('x.name')
					->orderBy(DB::raw('LENGTH(y.name)'))->orderBy('y.name')
					->orderBy(DB::raw('LENGTH(z.name)'))->orderBy('z.name')
					->orderBy(DB::raw('LENGTH(sections.name)'))->orderBy('sections.name');
	}
}
